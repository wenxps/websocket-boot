package com.weniya.socket.springwebsocket.config;// WebSocketConfiguration.java

import com.weniya.socket.springwebsocket.websocket.DemoWebSocketHandler;
import com.weniya.socket.springwebsocket.websocket.DemoWebSocketShakeInterceptor;
